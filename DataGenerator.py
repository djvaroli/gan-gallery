...
class DataGenerator():
    ...
    def __getitem__(self, index):
        ...
        embedded_batch_labels = np.array([self.embed_words(labels) for labels in batch_correct_labels_split])
        ...
        return (batch_correct_labels, correct_image_arrays, batch_wrong_labels, wrong_image_arrays)
